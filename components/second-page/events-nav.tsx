    ...
    <header className="sticky top-0 z-50 border-b border-maroon/10 bg-antique-white/85 backdrop-blur-xl">
      <div className="mx-auto flex w-full max-w-7xl items-center justify-between px-4 py-4 sm:px-6 lg:px-8">
        <div className="flex items-center gap-3">
          <div className="h-14 w-55 overflow-hidden rounded-lg border border-maroon/20 bg-white px-2 py-1 shadow-sm">
            <Image src="/du_logo.png" alt="DU logo" width={220} height={56} className="h-full w-full object-contain" />
          </div>
        </div>
